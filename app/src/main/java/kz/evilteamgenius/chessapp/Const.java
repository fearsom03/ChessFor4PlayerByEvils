...
public class Const {
	...
	public static final String address = "ws://192.168.0.103:8080/kchess/websocket";

	public static final String broadcast = "/app/makeMove";
	public static final String broadcastResponse = "/topic/makeMove";
