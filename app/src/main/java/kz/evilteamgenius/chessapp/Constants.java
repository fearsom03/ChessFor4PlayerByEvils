...
public class Constants {
    ...
    //   public static final String URL_GET_LATEST_MOVE2P = "https://k-chess.herokuapp.com/api/game/get/move";
    //   public static final String URL_MAKE_MOVE_GAME2P = "https://k-chess.herokuapp.com/api/game/make/move";

    public static final String Url_BASE = "http://192.168.0.103:5000";
    public static final String UrlDefault ="http://192.168.0.103:5000/";
    public static final String URL_GET_LATEST_MOVE2P = "http://192.168.0.103:5000/api/game2p/get/move";
    public static final String URL_MAKE_MOVE_GAME2P = "http://192.168.0.103:5000/api/game2p/make/move";
